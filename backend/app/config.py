...
class Settings(BaseSettings):
    ...
    HF_TEXT_MODEL: str = "microsoft/DialoGPT-medium"  # Text generation model
    HF_CODE_MODEL: str = "microsoft/DialoGPT-medium"  # Code generation model (same as text)
    HF_FALLBACK_MODEL: str = "gpt2"  # Ultimate fallback model
