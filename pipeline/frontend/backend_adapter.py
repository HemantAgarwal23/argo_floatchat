...
class BackendAdapter:
    ...
    def _setup_direct_mode(self) -> bool:
        ...
        try:
            ...
            backend_path = Path(__file__).parent.parent / "argo-ai-backend"
    ...
    def process_natural_language_query(self, query: str, filters: Dict = None) -> Dict[str, Any]:
        """Process natural language query"""
        try:
            if self.direct_mode:
                return self._process_query_direct(query, filters)
            else:
                return self._process_query_http(query, filters)
        except Exception as e:
    ...
    def _process_query_http(self, query: str, filters: Dict = None) -> Dict[str, Any]:
